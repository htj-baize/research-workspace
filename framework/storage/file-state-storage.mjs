...
function loadScenarioStorage(basePath, strategy) {
  const localSession = readJson(`../../demos/data/${basePath}/local/session.json`);
  const cloudSession = readJson(`../../demos/data/${basePath}/cloud/session.json`);
  const localMemory = readJson(`../../demos/data/${basePath}/local/memory.json`);
  const cloudMemory = readJson(`../../demos/data/${basePath}/cloud/memory.json`);
  const localConstraints = readJson(`../../demos/data/${basePath}/local/constraints.json`);
  const cloudConstraints = readJson(`../../demos/data/${basePath}/cloud/constraints.json`);
  const supply = readJson(`../../demos/data/${basePath}/shared/supply.json`);
